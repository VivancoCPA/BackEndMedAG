...
namespace SamplVSSkill.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260614023010_UserCita")]
    partial class UserCita
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SamplVSSkill.Domain.Entities.AppointmentUser", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.ToTable("appointment_users", (string)null);
                });
            ...
            modelBuilder.Entity("SamplVSSkill.Domain.Entities.UserScope", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.Property<string>("UserIdAdmin")
                        .IsRequired()
                        .HasColumnType("text")
                        .HasColumnName("user_id_admin");

                    b.HasKey("Id");

                    b.HasIndex("UserId");

                    b.HasIndex("UserIdAdmin");

                    b.ToTable("user_scope", (string)null);
                });
            ...
            modelBuilder.Entity("SamplVSSkill.Domain.Entities.AppointmentUser", b =>
                {
                    ...
                    b.HasOne("SamplVSSkill.Domain.Entities.Specialty", "Specialty")
                        .WithMany()
            ...
            modelBuilder.Entity("SamplVSSkill.Domain.Entities.UserScope", b =>
                {
                    ...
                    b.HasOne("SamplVSSkill.Domain.Entities.AppUser", "UserAdmin")
                        .WithMany()
                        .HasForeignKey("UserIdAdmin")
                        .OnDelete(DeleteBehavior.SetNull);
